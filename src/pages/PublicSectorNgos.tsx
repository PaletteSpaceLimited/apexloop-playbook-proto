...
const featureSections = [
  ...
  {
    title: "Navigate Sensitive Conversations",
    description: "Practice handling emotionally charged situations, crisis communications, and sensitive topics. Build confidence in staff to manage difficult interactions professionally.",
    icon: Heart,
    imagePosition: "right" as const
  },
  {
    title: "Scale Training on Limited Budgets",
    description: "Maximize training impact without expensive in-person sessions. AI-driven practice provides unlimited repetitions at a fraction of traditional training costs.",
    icon: Globe,
    imagePosition: "left" as const
  }
];
...
const faqs = [
  {
    question: "Can ApexLoop be customized for public sector scenarios?",
    answer: "Yes! ApexLoop supports custom roleplays for citizen interactions, donor conversations, policy explanations, and scenarios specific to government agencies and NGOs."
  },
  {
    question: "How long does set-up and onboarding take?",
    answer: "Building your first bot and scorecard takes less than 10 minutes. Building out your personas and setting up modules take two weeks on average. Most organizations see the value in the first 30 days."
  },
  {
  ...
  {
    question: "Is ApexLoop compliant with government data security requirements?",
    answer: "ApexLoop takes data security seriously. We do not train on your data, and all information is encrypted and stored securely. Contact us for specific compliance requirements."
  },
  {
  ...
  {
    question: "Can we use ApexLoop for volunteer training?",
    answer: "Absolutely! ApexLoop is perfect for training volunteers on community engagement, donor conversations, and service delivery. The platform scales easily to accommodate volunteer cohorts."
  }
];

// Stats data
const stats = [
  { value: "40%", label: "Reduction in Training Costs" },
  { value: "55%", label: "Improvement in Service Ratings" },
  { value: "3x", label: "More Staff Trained per Budget" }
];

export default function PublicSectorNgos() {
      ...
      <section className="py-20 px-6 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-body mb-8 max-w-2xl mx-auto">
            Government agencies and NGOs need to deliver consistent, empathetic service while navigating complex policies and diverse stakeholder needs.
          </p>
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-primary/10 to-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-body mb-8 max-w-lg mx-auto">
            Join public sector organizations and NGOs already using ApexLoop to improve their stakeholder engagement.
          </p>
