...
const stats = [
  { value: "50,000+", label: "Roleplays Completed" },
  { value: "40%", label: "Close Rate Increase" },
  { value: "66%", label: "Faster Ramp Time" },
];
...
const costBreakdown = [
  { pain: "Long Ramp Time", cost: "$1.8M", detail: "10 new SDRs × 6 months × $30K 'dead money'" },
  { pain: "Wasted Prospects", cost: "$500K", detail: "10 new SDRs × 50 prospects × $1K wasted" },
  { pain: "Performance Gap", cost: "$1.5M", detail: "Mid-tier reps could generate 20% more pipeline" },
  { pain: "Manager Time Drain", cost: "$180K", detail: "5 managers × 30% automatable time" },
  { pain: "Change Management", cost: "$1M", detail: "10 changes/year × $100K per change" },
];
...
const caseStudy = {
  ...
  resultsBefore: [
    { label: "3-Month Retention", value: "47.5%" },
    { label: "First-month Close Rate", value: "5%" },
    { label: "New-hire Confidence", value: "3.2/10" },
    { label: "Annual Waste", value: "$9M" },
  ],
  resultsAfter: [
    { label: "3-Month Retention", value: "81%" },
    { label: "First-month Close Rate", value: "13%" },
    { label: "New-hire Confidence", value: "7.8/10" },
    { label: "Estimated Savings", value: "$5.2M" },
  ],
...
const industries = [
  { name: "Insurance & Financial Services", description: "Train advisors to handle sensitive, regulated conversations with confidence" },
  { name: "B2B SaaS & IT Solution Providers", description: "Master complex, high-stakes product conversations" },
  { name: "Customer Support & Success Teams", description: "Standardize responses and improve outcomes across every interaction" },
  { name: "Recruitment & Talent Consulting", description: "Improve consultant performance across candidate and client conversations" },
  { name: "Education & Training Providers", description: "Coach advisors and admissions teams for high-value enrollment conversations" },
  { name: "Public Sector & NGOs", description: "Prepare staff for public, stakeholder, and community-facing communication" },
];
      ...
      <section className="relative py-20 lg:py-32 px-6">
        ...
        <div className="relative max-w-6xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent/10 text-accent mb-8">
            ...
            <span className="text-sm font-medium">AI Sales Performance Enablement Platform</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-body max-w-3xl mx-auto mb-10">
            Elite athletes don't just "do their job" to improve. They practice specific skills repeatedly, 
            get immediate feedback, and train in realistic but low-stakes environments. 
      ...
      <section className="py-24 px-6 gradient-primary-bg">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {challenges.map((item) => (
              <div key={item.title} className="bg-primary-foreground/10 backdrop-blur-sm rounded-2xl p-6 border border-primary-foreground/20">
              ...
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {capability.features.map((feature) => (
                    <span key={feature} className="text-xs font-medium px-3 py-1 bg-accent/10 text-accent rounded-full">
                      {feature}
                    </span>
                  ))}
                </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {scenarios.map((scenario) => (
              <div key={scenario.title} className="bg-background rounded-2xl p-8 border border-border hover:border-accent/30 transition-colors">
            ...
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {caseStudy.resultsBefore.map((result) => (
                    <div key={result.label} className="bg-gray-700/50 rounded-lg p-4">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {caseStudy.resultsAfter.map((result) => (
                    <div key={result.label} className="bg-gray-700/50 rounded-lg p-4">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {industries.map((industry) => (
              <div key={industry.name} className="bg-background rounded-xl p-6 border border-border hover:border-accent/30 transition-colors">
      ...
      <section className="py-24 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-background rounded-2xl border border-border overflow-hidden">
            ...
            {[
              { challenge: "Coach to Rep Ratio", old: "1 manager : 8 reps", new: "1 AI coach : ∞ reps" },
              { challenge: "Practice Frequency", old: "2-3 roleplays/month per rep", new: "Unlimited practice calls" },
              { challenge: "Feedback Quality", old: "Generic feedback", new: "Hyper-specific, timestamped insights" },
              { challenge: "Manager Time", old: "10-15 hrs/week", new: "1-2 hrs/week" },
              { challenge: "Ramp Time", old: "6 month ramp time", new: "2 month ramp time" },
            ].map((row, index) => (
              <div key={row.challenge} className={`grid md:grid-cols-3 border-t border-border ${index % 2 === 0 ? 'bg-muted/30' : ''}`}>
                <div className="p-6">
