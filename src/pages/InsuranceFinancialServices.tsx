...
const featureSections = [
  {
    title: "Training Junior Advisors for High-Value Prospecting",
    description: "Junior advisors struggle with outreach. AI-driven roleplays, objection-handling training, and real-time feedback help them book more meetings with high-net-worth clients.",
    icon: TrendingUp,
    imagePosition: "right" as const
  },
  {
    title: "Improving SDR Call Performance & Lead Qualification",
    description: "Financial SDRs handle high call volumes, but training is often inconsistent. AI analyzes every call, highlights missed opportunities, and delivers real-time coaching to improve conversions.",
    icon: Phone,
    imagePosition: "left" as const
  },
  {
    title: "Coaching Advisors on Emotional Client Conversations",
    description: "Clients make financial decisions emotionally, not just logically. Simulated client interactions help advisors practice handling market volatility, portfolio changes, and tough conversations with confidence.",
    icon: MessageSquare,
    imagePosition: "right" as const
  },
  {
    title: "Handling Fee Objections & Asset Consolidation Conversations",
    description: "Fee objections and asset consolidation impact long-term revenue. AI-driven training helps advisors justify value, shift conversations from cost to strategy, and turn objections into AUM growth.",
    icon: Briefcase,
    imagePosition: "left" as const
  }
];
...
const faqs = [
  {
    ...
    answer: "Yes! ApexLoop supports custom roleplays for any ICP, AI scorecards for any sales methodology or messaging frameworks, and industry-specific objections for insurance and financial services."
  },
  {
...
const stats = [
  ...
  { value: "50%", label: "Faster Advisor Ramp Time" },
  { value: "2x", label: "More Client Meetings Booked" }
];

export default function InsuranceFinancialServices() {
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-primary/10 to-accent/10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-body mb-8 max-w-lg mx-auto">
            Join hundreds of financial services teams already using ApexLoop to improve their client conversations.
          </p>
