        ...
        <div className="flex h-16 items-center">
          ...
          <div className="hidden lg:flex items-center flex-1">
            ...
            <div className="relative group/resources">
              <button className="flex items-center gap-1 h-10 px-4 py-2 text-sm font-medium text-body rounded-md transition-colors group-hover/resources:bg-accent/50 group-hover/resources:text-accent-foreground group-hover/resources:font-semibold">
                Resources
